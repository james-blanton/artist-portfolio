...
The file's purpose is to display a table which lists all of the paintings that have been submitted to the database.
...
$sql = "SELECT COUNT(*) FROM artwork WHERE category = 'Painting'";
...
$sql = "SELECT * FROM artwork WHERE category = 'Painting' ORDER BY id DESC LIMIT $offset, $rowsperpage";
